...
<body>
	...
	<div>
       ...
       <span> <img style="max-width:125px; margin-top: -7px;"
        src="${pageContext.request.contextPath}/assets/img/eintern-logo.png"></span>
        </a>
		</div>
		<div class="navbar-collapse collapse">
			<ul class="nav navbar-nav">
				...
				<!-- dropdown -->
				<li><a href="expense.do">Expenses</a> <!-- <ul class="dropdown-menu">
						<li><a href="#">Report Spending</a></li>
						<li><a href="#">Edit Expense</a></li>
					</ul> --></li>
				<li><a href="income.do">Income</a> <!-- <ul class="dropdown-menu">
                    ...
                    <div class="intro-message">
                        ...
                        <ul class="list-inline intro-social-buttons">
                          <!--   <li>
                            ...
                            <li>
                                <a href="home.do" class="btn btn-default btn-lg"><span class="network-name">Enter</span></a>
                            </li>
                           <!--  <li>
